...
const ContactValueMap: Record<ContactType, ContactValue> = {
  ...
  [ContactType.WebSite]: {Icon: ResearchIcon, srLabel: 'Website'}, // Using EnvelopeIcon as a placeholder for Website
};

const Contact: FC = memo(() => {
  const {headerText, description, items} = contact;
  return (
    <Section className="bg-anaranjadoCasiOscuro" sectionId={SectionId.Contact}>
      <div className="flex flex-col gap-y-6">
        ...
        <div className="grid grid-cols-1 gap-6 md:grid-cols-2 ">
          ...
          <div className="order-2 col-span-1 md:order-2 flex justify-center items-center">
